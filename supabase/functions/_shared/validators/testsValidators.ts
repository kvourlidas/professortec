...
export function validateCreateTestBody(body: any) {
  ...
  if (!class_id && !level_id) throw new ValidationError("Missing class_id");
  ...
  return { class_id, level_id, subject_id, test_date, start_time, end_time, title, description };
}
...
export function validateUpdateTestBody(body: any): UpdateTestInput {
  ...
  return { test_id, class_id, level_id, subject_id, test_date, start_time, end_time, title, active_during_holiday };
}
