  ...
  definition: {
    ...
    input_schema: {
      ...
      properties: {
        ...
        address: { type: "string", description: "Διεύθυνση κατοικίας μαθητή" },
        school_name: { type: "string", description: "Σχολείο φοίτησης μαθητή" },
        ...
        father_afm: { type: "string", description: "ΑΦΜ πατέρα (9 ψηφία)" },
        ...
        mother_afm: { type: "string", description: "ΑΦΜ μητέρας (9 ψηφία)" },
      },
      required: ["full_name"],
