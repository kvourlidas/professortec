  ...
  definition: {
    ...
    input_schema: {
      ...
      properties: {
        ...
        address: { type: "string", description: "Νέα διεύθυνση κατοικίας, αν αλλάζει." },
        school_name: { type: "string", description: "Νέο σχολείο φοίτησης, αν αλλάζει." },
        ...
        father_afm: { type: "string", description: "Νέο ΑΦΜ πατέρα (9 ψηφία), αν αλλάζει." },
        ...
        mother_afm: { type: "string", description: "Νέο ΑΦΜ μητέρας (9 ψηφία), αν αλλάζει." },
      },
      required: [],
  ...
  async execute(input, { supabase, schoolId }) {
    ...
    const result = await updateStudentByNameService(supabase, schoolId, {
      ...
      updates: {
        ...
        school_name: str(input?.school_name),
        ...
        father_afm: str(input?.father_afm),
        ...
        mother_afm: str(input?.mother_afm),
      },
    });
