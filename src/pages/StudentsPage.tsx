      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-2.5">
          ...
          <button type="button" onClick={() => setCreateModalOpen(true)}
            className="btn-primary h-9 gap-2 px-4 font-semibold">
                      ...
                      <td className="px-5 py-3.5">
                        <div className="flex items-center justify-end gap-1.5">
                          ...
                          <button
                            ...
                            className={`inline-flex items-center gap-1.5 rounded-lg border px-2.5 py-1 text-[11px] font-medium transition ${isDark ? 'border-slate-600/50 bg-slate-800/40 text-slate-300 hover:border-slate-500 hover:bg-slate-700/50 hover:text-white' : 'border-slate-200 bg-slate-50 text-slate-600 hover:border-slate-300 hover:bg-slate-100 hover:text-slate-800'}`}
                            title="Κάρτα μαθητή"
                          >
          ...
          <div className={`relative w-full max-w-sm overflow-hidden rounded-2xl border shadow-2xl ${modalBg}`}>
            ...
            <div className="p-6">
              ...
              <div className="mt-6 flex justify-end gap-2.5">
                <button type="button" onClick={() => { if (!deleting) setDeleteTarget(null); }} disabled={deleting} className={cancelBtnCls}>
                  Ακύρωση
                </button>
