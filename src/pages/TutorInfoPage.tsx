...
export default function TutorInfoPage() {
    ...
    <div className="max-w-2xl space-y-10 px-1">
      ...
      <section className="space-y-5">
        <div className="flex items-start justify-between gap-3">
          <div>
            <h1 className="text-sm font-semibold" style={{ color: 'var(--color-text-main)' }}>Τα Στοιχεία μου</h1>
            <p className="mt-0.5 text-xs" style={{ color: 'var(--color-text-muted)' }}>Προσωπικά στοιχεία επικοινωνίας</p>
          </div>
          {!loading && !editing && (
            <button
              type="button"
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="form-label">
                <User className="mr-1.5 inline-block h-3.5 w-3.5 opacity-60" />
                Ονοματεπώνυμο
              </label>
              {editing ? (
                <input
