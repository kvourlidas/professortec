...
const STYLE_ID = 'ct-datepicker-styles';

function injectStyles(isDark: boolean) {
  if (typeof document === 'undefined') return;

  // Remove existing style to re-inject with current theme
  ...
  if (isDark) {
    style.textContent = `
      .ct-datepicker-popper { z-index: 9999 !important; }
      .ct-datepicker {
      ...
      .ct-datepicker .react-datepicker__navigation { top: 0.85rem !important; }
      ...
      .ct-datepicker .react-datepicker__day-names { margin-top: 0.25rem !important; }
      ...
      .ct-datepicker .react-datepicker__month { margin: 0 !important; }
      .ct-datepicker .react-datepicker__day {
        color: rgb(203 213 225) !important;
        font-size: 0.7rem !important; font-weight: 400 !important;
        width: 2rem !important; height: 2rem !important; line-height: 2rem !important;
        border-radius: 0.5rem !important; margin: 0 !important;
      ...
      .ct-datepicker .react-datepicker__day--selected:hover {
        background: var(--color-accent) !important; filter: brightness(1.1) !important;
      }
      ...
      .ct-datepicker .react-datepicker__day--outside-month { color: rgb(51 65 85) !important; }
      .ct-datepicker .react-datepicker__day--disabled {
        color: rgb(51 65 85) !important; cursor: not-allowed !important;
      }
      .ct-datepicker .react-datepicker__day--disabled:hover { background: transparent !important; }
      ...
      .ct-datepicker .react-datepicker__year-dropdown-container { margin: 0 0.2rem !important; }
      .ct-datepicker-popper .react-datepicker__triangle { display: none !important; }
    `;
  } else {
    style.textContent = `
      .ct-datepicker-popper { z-index: 9999 !important; }
      .ct-datepicker {
        ...
        border-radius: 0.75rem !important;
        box-shadow: 0 10px 30px rgb(0 0 0 / 0.1), 0 0 0 1px rgb(0 0 0 / 0.04) !important;
        backdrop-filter: blur(12px) !important;
        padding: 0.75rem !important;
        font-family: inherit !important;
      }
      ...
      .ct-datepicker .react-datepicker__day--outside-month { color: rgb(203 213 225) !important; }
      .ct-datepicker .react-datepicker__day--disabled {
        color: rgb(203 213 225) !important; cursor: not-allowed !important;
      }
      .ct-datepicker .react-datepicker__day--disabled:hover { background: transparent !important; }
      .ct-datepicker .react-datepicker__month-select,
      .ct-datepicker .react-datepicker__year-select {
...
const DatePickerField: React.FC<DatePickerFieldProps> = ({
  ...
  return (
    <div className="space-y-1.5">
      {label && (
        <label htmlFor={id} className={`block text-[10px] font-semibold uppercase tracking-wider ${isDark ? 'text-slate-500' : 'text-slate-400'}`}>
          {label}
        </label>
      )}
      <DatePicker
