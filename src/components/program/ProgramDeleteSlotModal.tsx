...
interface ProgramDeleteSlotModalProps {
...
export default function ProgramDeleteSlotModal({ target, deleting, isDark, onCancel, onConfirm }: ProgramDeleteSlotModalProps) {
